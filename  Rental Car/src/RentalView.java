...
////////////////////////////////////////////////customer info//////////////////////////////////////
	private JLabel customerL, firstNameL, lastNameL, locationL, contactL, genderL, ageL, statusL, showAgeL,lisno; //inside the panel of customerP
	private JTextField firstNameTF, lastNameTF, locationTF, contactTF, genderTF, statusTF,lisnoTF;
	private JLabel firstNameChecker, lastNameChecker, genderChecker, statusChecker, locationChecker, contactChecker,lisnoChecker;
...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//--------------------------------------COMBO BOX for current date
		...
		Integer[] currentYearCB = {2019, 2020 ,2021 ,2022 ,2023};
	...
	//---------------------------------------------Pick up date section
		...
		Integer[] pickUpYearCB = {2019, 2020, 2021, 2022, 2023};
	...
	//-------------------------------------------return date section
		...
		Integer[] returnYearCB = {2019, 2020, 2021, 2022, 2023};
	...
	//---------------------------------------------birth date section
		...
		Integer[] birthYearCB = {1985, 1986, 1987, 1988, 1989, 1990,
	...
	//---------------------------------------------LEBELS for customer details
		...
		lisno=new JLabel("LicenseNo:");
		lisno.setFont(new Font("Serif", Font.BOLD, 15));
		lisno.setForeground(Color.BLUE);
		lisno.setBounds(50,305,250,30);
		customerP.add(lisno);
	...
	//-------------------------------------TEXT FIELD for customer details and get data from keyboard section
		...
		lisnoTF = new JTextField();
		lisnoTF.setHorizontalAlignment(JTextField.CENTER);
		lisnoTF.setForeground(Color.GRAY);
		lisnoTF.setBounds(150,300,250,30);
		customerP.add(lisnoTF);
		...
		lisnoChecker= new JLabel("");
		lisnoChecker.setFont(new Font("Serif", Font.BOLD, 15));
		lisnoChecker.setBounds(410,500,100,100);
		customerP.add(lisnoChecker);

	//-------------------------------------------BUTTONS for customer
	//----------------------------------------------to go pick a car section
	//	ImageIcon customerNextImage = new ImageIcon("../images/car.GIF");
		customerNextB = new JButton("Next");
		customerNextB.setBackground(Color.WHITE);
		customerNextB.setBounds(460, 450, 100, 50);
	...
	//	ImageIcon customerBackImage = new ImageIcon("../images/customer_back.GIF");
		customerBackB = new JButton("Back");
		customerBackB.setBackground(Color.WHITE);
		customerBackB.setBounds(330, 450, 100, 50);
	...
	//---------------------------------------------------------Pick Car Buttton]
	//-------------------------------------first car button
		ImageIcon firstCarImage = new ImageIcon("/home/pawar/IdeaProjects/Romy Car Rental/images/van.gif");
	...
	//---------------------------------second car button
		ImageIcon secondCarImage = new ImageIcon("/home/pawar/IdeaProjects/Romy Car Rental/images/pickup.GIF");
	...
	//---------------------------------------third car button
		ImageIcon thirdCarImage = new ImageIcon("/home/pawar/IdeaProjects/Romy Car Rental/images/jeepney.gif");
	...
	//------------------------------------------forth car button
		ImageIcon forthCarImage = new ImageIcon("/home/pawar/IdeaProjects/Romy Car Rental/images/limousine.gif");
	...
	private class customerNextButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("NextToPickCar")) {
				...
				String firstName, lastName, license,gender, status, location, contact;
				...
				license = lisnoTF.getText();
				
				aCustomer.setCustomer(firstName, lastName, gender, status, location, contact,license);
				...
				if(aCustomer.getStatus().equals("")) { //for status
				...
				if(aCustomer.getLicense().equals("")) { // checker for firstname if empty , its invalid
					lisnoChecker.setForeground(Color.RED);
					lisnoChecker.setText("Invalid!");
				}

				else {
					lisnoChecker.setForeground(Color.GREEN);
					lisnoChecker.setText("Valid");
				}
				
				if(!aCustomer.getFirstName().equals("") && !aCustomer.getLastName().equals("") && !aCustomer.getGender().equals("") && !aCustomer.getStatus().equals("") && !aCustomer.getLocation().equals("") && !aCustomer.getContact().equals("") && !aCustomer.getLicense().equals("")){
